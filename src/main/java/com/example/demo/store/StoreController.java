...
public class StoreController {
    ...
    String home() {
		...
		/*
		 * ProductEntity bottle = new ProductEntity(); bottle.setName("Best OJ ever");
		 * bottle.setPrice(33.88F); productEntityCrudRepository.save(bottle);
		 * 
		 * ProductEntity cookie = new ProductEntity();
		 * cookie.setName("Best Cookie ever"); cookie.setPrice(43.48F);
